...
import { FaCalendarAlt, FaRegCreditCard, FaRegTrashAlt } from "react-icons/fa";
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-8">
            ...
            {cartItems.length === 0 ? (
              <div className="bg-white rounded-xl shadow-md overflow-hidden">
                <div className="text-center py-12">
                  ...
                  <button onClick={handleViewEventsClick} className="bg-gradient-to-r from-purple-600 to-blue-600 cursor-pointer text-white hover:from-purple-700 hover:to-blue-700 px-6 py-2 rounded-lg font-medium">
                    Browse Events
                  </button>
                </div>
              </div>
                    ...
                    <div className="flex flex-col gap-4">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="text-sm text-gray-600 space-y-1">
                          ...
                          <div className="flex items-center gap-2">
                            <FaLocationDot className="h-4 w-4 text-blue-500" />
          ...
          {cartItems.length > 0 && (
            <div className="space-y-6">
              ...
              {/* Checkout Button */}
              <button className="w-full cursor-pointer bg-gradient-to-r from-purple-600 to-blue-600 text-white hover:from-purple-700 hover:to-blue-700 py-3 text-lg font-semibold rounded-lg transition-all duration-300">
                <FaRegCreditCard className="mr-2 h-5 w-5 inline" />
                Proceed to Checkout
              </button>

              {/* Security Notice */}
              <div className="flex items-center gap-2 text-sm text-gray-500">
                <IoShieldCheckmarkSharp className="h-4 w-4 text-blue-500" />
