...
import { FaLocationDot, FaMinus, FaPlus, FaUser } from "react-icons/fa6";
...
const EventDetails = () => {
  ...
  const event = {
    ...
    ticketTypes: [
      ...
      { name: "Weekend Pass", price: 199, description: "3-day access to all events and activities" }
    ]
  };
        ...
        <div className="absolute bottom-6 left-6 text-white">
          ...
          <div className="flex items-center gap-4 text-sm">
            ...
            <div className="flex items-center gap-1">
              <CiStar className="h-4 w-4 fill-yellow-400 text-yellow-400" />
            ...
            <div className="bg-white rounded-xl shadow-md p-6">
              ...
              <div className="grid grid-cols-2 xl:grid-cols-3 gap-4">
                {event.lineup.map((artist, index) => (
                  <div key={index} className="text-center p-4 bg-gradient-to-br from-purple-50 to-blue-50 rounded-lg border border-purple-100">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-4 pt-2">
                  ...
                  <button 
                    ...
                    className="w-full py-3 bg-gradient-to-r from-purple-600 to-blue-600 text-white hover:from-purple-700 hover:to-blue-700 rounded-lg font-medium transition-colors duration-200"
                  >
                    Add to Cart
                  </button>
                </div>
