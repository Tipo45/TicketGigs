          ...
          {steps.map((step, index) => (
            <div key={index} className="relative text-center">
              ...
              {index < steps.length - 1 && (
                <div className="hidden absolute top-20 left-1/2 w-full h-0.5 bg-gradient-to-r from-purple-300 to-pink-300 transform -translate-y-1/2 translate-x-8"></div>
              )}
              ...
              <div className="relative z-10 bg-white rounded-3xl p-8 shadow-lg hover:shadow-2xl transition-shadow duration-300">
                ...
                <div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-r from-purple-100 to-pink-100 rounded-2xl mb-6 mt-4">
