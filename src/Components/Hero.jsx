...
const Header = () => {
  ...
  return (
    <section className="relative min-h-screen bg-gradient-to-br from-purple-600 via-blue-600 to-indigo-800 flex items-center justify-center overflow-hidden">
      {/* Background Overlay */}
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 text-center text-white">
        ...
        <div className="animate-fade-in">
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-xl p-6 max-w-3xl mx-auto mb-8 border border-white/20">
            ...
            <button className="w-full cursor-pointer mt-4 py-3 text-lg font-semibold bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 rounded-lg transition-all duration-300">
              Find Events
            </button>
          </div>
      ...
      {/* Decorative Elements */}
      <div className="absolute top-1/4 left-10 w-16 h-16 rounded-full bg-gradient-to-r from-pink-400 to-purple-400 opacity-20 animate-float"></div>
      <div className="absolute bottom-1/4 right-10 w-24 h-24 rounded-full bg-gradient-to-r from-blue-400 to-indigo-400 opacity-20 animate-float-delay"></div>
    </section>
  );
};
