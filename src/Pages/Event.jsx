                ...
                <div className="p-6">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center gap-2 text-gray-500">
                      ...
                      <FaRegClock className="h-4 w-4 ml-2 text-blue-500" />
                    ...
                    <button onClick={handleViewEventDetails} className="w-full cursor-pointer mt-4 bg-gradient-to-r from-purple-600 to-blue-600 text-white hover:from-purple-700 hover:to-blue-700 py-2 rounded-lg font-medium">
                      View Details
                    </button>
                  </div>
                </div>
