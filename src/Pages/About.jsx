import { FaAward, FaRegHeart, FaUsers } from "react-icons/fa";
import { PiTargetBold } from "react-icons/pi";

const About = () => {
  const values = [
    {
      icon: <PiTargetBold className="text-3xl text-purple-600" />,
      title: "Our Mission",
    ...
    {
      icon: <FaRegHeart className="text-3xl text-pink-600" />,
      title: "Passion",
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* Hero Section */}
      <section className="relative bg-gradient-to-br from-purple-600 via-blue-600 to-indigo-800 text-white py-20">
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          <div className="flex flex-col lg:flex-row gap-4 justify-center">
            <button className="bg-gradient-to-r from-purple-600 to-pink-600 cursor-pointer text-white px-8 py-3 rounded-lg font-semibold hover:from-purple-700 hover:to-pink-700 transition-all">
              Contact Us
            </button>
